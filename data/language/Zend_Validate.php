...
return array(
    ...
    "Maximum allowed size for file is '%max%' but '%size%' detected" => "O tamanho máximo permitido para o arquivo é '%max%' mas '%size%' detectado",
    "Minimum expected size for file is '%min%' but '%size%' detected" => "O tamanho mínimo esperado para o arquivo é '%min%' mas '%size%' detectado",
    "File is not readable or does not exist" => "O arquivo não é legível ou não existe",

    // Zend\Validator\File\Extension
    "File has an incorrect extension" => "O arquivo tem uma extensão incorreta",
    "File is not readable or does not exist" => "O arquivo não é legível ou não existe",

    // Zend\Validator\File\MimeType
    "File has an incorrect mimetype of '%type%'" => "O arquivo tem um mimetype incorreto '%type%'",
    "The mimetype could not be detected from the file" => "O mimetype não pôde ser detectado a partir do arquivo",
    "File is not readable or does not exist" => "O arquivo não é legível ou não existe",
);
